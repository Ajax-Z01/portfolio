...
<head>
    ...
    <!-- SEO Meta Tags for Portfolio - Azhar Abdul A'la -->
    <meta name="description" content="Portfolio of Azhar Abdul A'la, showcasing skills, projects, and expertise in web development and design.">
    <meta name="keywords" content="Azhar Abdul A'la, portfolio, web development, design, projects, skills">
    <meta name="author" content="Azhar Abdul A'la">

    <!-- OG Meta Tags -->
    <meta name="og:title" content="Portfolio Azhar Abdul A'la">
    <meta name="og:description" content="Explore the portfolio of Azhar Abdul A'la, a skilled web developer and designer. View projects and expertise in web development and design.">
    <meta name="og:type" content="website">
    <meta name="og:url" content="https://www.yourportfolio.com">
    <meta name="og:image" content="https://www.yourportfolio.com/images/cover.jpg">

    <!-- Webpage Title -->
    <title>Portfolio Azhar Abdul A'la</title>
...
<body class="bg-gray2" data-spy="scroll" data-target=".fixed-top">

    <!-- Navigation -->
    <nav class="navbar fixed-top">
        <div class="container py-3 sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
            ...
            <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center" id="navbarsExampleDefault">
                <ul class="text-lg pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                    <li>
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            <div class="mb-8 lg:mt-24 xl:mt-28 xl:mr-12 text-center">
                ...
                <div class="flex justify-center">
                    <a class="btn-solid-lg mr-4 page-scroll" href="#contact">
                        <i class="fa-solid fa-envelope mr-2"></i>Contact me
                    </a>
                </div>
            </div>
            <div class="lg:text-right xl:text-right">
                <img class="object-cover w-3/4 inline" src="images/foto.png" alt="Azhar Image" />
            </div>
        </div> <!-- end of container -->
    ...
    <!-- About me -->
    <div id="about" class="pt-24 pb-2 text-center">
